...
export const NAV_GROUPS = [
  ...
  {
    label: "Consultant",
    items: NAV_ITEMS.filter(item => ["onboarding", "requests", "followups", "bots"].includes(item.id)),
  },
  {
    label: "Admin",
    items: NAV_ITEMS.filter(item => ["private-clients", "analytics", "settings"].includes(item.id)),
  },
];
